    """
    Chat Template Engine 9jqz0
    ==========================
    Developer-friendly AI library that helps you extract documents programmatically.
    ...
    APP_NAME    = "Chat Template Engine 9jqz0"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly AI library that helps you extract documents programmatically.")
